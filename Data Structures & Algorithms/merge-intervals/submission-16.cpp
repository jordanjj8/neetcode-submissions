...
public:
    vector<vector<int>> merge(vector<vector<int>>& intervals) {
        ...
        // 2. iterate through intervals starting with index 1 using i
        // a. if intervals[i][0] >= intervals[i-1][1]
        //  then new interval [intervals[i-1][0], intervals[i][1]], where we add to results
        // if not then add intervals[i] into results
        // 
        // ex: [1,2][3,5][5,8][9,10]
        //                       i   
        // result [1,2], [3,8] [9, 10]
